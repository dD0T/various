...
#
#    Copyright (C) 2007 Christian Brugger
#    Copyright (C) 2007 Stefan Hacker <dd0t@users.sourceforge.net>
#
...
class TextElement(object):
    ...
    def createTexture(self):
        ...
        # REMARK: 500ms --> 0.5ms on an ATI-GPU powered Notebook compared to
        #         non power of two. A NVIDIA cards doesn't seem to have this issue.
